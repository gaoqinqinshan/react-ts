    ...
    <>
      <Container className="mt-12 md:mt-16">
        <div className="max-w-2xl">
          ...
          Hello 👋, I’m Shenfan Laogou, an AI RD and PM. <br/> 你好 👋，我是Kevin ，一名励志成为一个懂RD的PM。
          </p>
          <p className="mt-4 text-base text-zinc-600 dark:text-zinc-400">
          There are so many things I want to say, but it feels too long-winded when I say them out. Come on, Xiao Gao. <br/> 想说的话太多，说出来又觉得很啰嗦，好好加油小高。
          </p>
          {/* <p className="mt-4 text-base text-zinc-600 dark:text-zinc-400">
